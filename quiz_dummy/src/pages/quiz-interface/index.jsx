...
const QuizInterface = () => {
  ...
  // Add new state for per-question timer
  ...
  // Navigation handlers - Remove previous navigation functionality
  const handleNext = () => {
  ...
  const handleSubmit = async () => {
    ...
    // Store results in sessionStorage for results page (simplified for leaderboard)
    const quizResults = {
      score: correctCount,
      totalQuestions: mockQuestions?.length,
      timeSpent: totalTimeSpent,
      completedAt: new Date()?.toISOString(),
      studentName: "Current Student" // In real app, get from auth
    };
