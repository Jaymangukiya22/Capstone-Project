...
class QuestionController {
    ...
    async addQuestionToQuiz(req, res, next) {
        try {
            ...
            const createdQuestion = await questionService_1.questionService.addQuestionToQuiz(quizId, questionText, options);
            res.status(201).json({
                success: true,
    ...
    async updateQuestion(req, res, next) {
        try {
            ...
            const updatedQuestion = await questionService_1.questionService.updateQuestion(id, questionText, options);
            res.status(200).json({
                success: true,
