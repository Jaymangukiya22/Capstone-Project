/**
 * Complete Quiz Import Script - Handles both JSON files
 * Imports from hardware.json and final proejct quizzes (1).json
 */
  ...
  try {
    ...
    if (fs.existsSync(HARDWARE_JSON)) {
      ...
      for (const [categoryName, questions] of Object.entries(hardwareData)) {
        ...
        console.log(`   ✅ ${categoryName}: ${questions.length} questions imported`);
      }
    } else {
