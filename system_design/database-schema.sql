...
CREATE UNIQUE INDEX idx_category_hierarchy_id ON category_hierarchy(id);
...
-- Function to refresh category hierarchy
...
CREATE TRIGGER refresh_category_hierarchy_trigger
AFTER INSERT OR UPDATE OR DELETE ON categories
FOR EACH STATEMENT EXECUTE FUNCTION refresh_category_hierarchy();
...
SELECT 
    ...
    AVG(qa.completion_percentage) as avg_completion,
    q.created_at,
...
('Science', 'Scientific subjects', NULL, 0, 'Science'),
('Technology', 'Technology and programming', NULL, 0, 'Technology'),
('Mathematics', 'Mathematical concepts', NULL, 0, 'Mathematics');

INSERT INTO categories (name, description, parent_id, level, path) VALUES
('Physics', 'Physics concepts', 1, 1, 'Science/Physics'),
('Chemistry', 'Chemistry concepts', 1, 1, 'Science/Chemistry'),
('Programming', 'Programming languages', 2, 1, 'Technology/Programming'),
('Web Development', 'Web technologies', 2, 1, 'Technology/Web Development');

-- Initial admin user (password: 'admin123' - change in production)
INSERT INTO users (username, email, password_hash, role, first_name, last_name) VALUES
('admin', 'admin@quizup.com', '$2b$10$YourHashedPasswordHere', 'ADMIN', 'Admin', 'User');
