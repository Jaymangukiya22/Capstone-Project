...
export declare const categoryQuerySchema: Joi.ObjectSchema<any>;
...
export declare const excelUploadSchema: Joi.ObjectSchema<any>;
export declare const assignQuestionsSchema: Joi.ObjectSchema<any>;
export declare const questionBankQuerySchema: Joi.ObjectSchema<any>;
