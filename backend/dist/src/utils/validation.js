...
exports.searchQuestionsSchema = joi_1.default.object({
    query: joi_1.default.string().min(1).max(200).optional(),
...
exports.completeQuizSchema = joi_1.default.object({
    attemptId: joi_1.default.number().integer().positive().required()
});
